...
<section>
  ...
  <div class="container" id="containerLogin">
    ...
    <form class="form" style="display: none;" action="seconnecter.php" method="post" onsubmit="return validateLoginForm()">
  ...
  <button type="submit" class="submitLoginn" name="login" id="login">Connexion</button>
  <div class="input-container ic2">
    <h6 id="forget">If you forget your password, click here <a href="fix.php" id="forgetlink">Forget</a></h6>
  </div>
  <br>
</form>
